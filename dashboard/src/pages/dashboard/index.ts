...
export const PackageDetails = lazy(() => import("./tour-package/PackageDetails"));
export const PackageForm = lazy(() => import("./tour-package/PackageForm"));
export const PackageCategories = lazy(() => import("./tour-package/packageMeta/PackageCategories"));
export const PackageServices = lazy(() => import("./tour-package/packageMeta/PackageServices"));
export const PackageFeatures = lazy(() => import("./tour-package/packageMeta/PackageFeatures"));
export const PackageItenaries = lazy(() => import("./tour-package/packageMeta/PackageItenaries"));
export const PackageMeta = lazy(() => import("./tour-package/packageMeta/PackageMetaManagement"));
