...
const PackageCategoryList = () => {
  ...
  const createCategory = useCreatePackageCategory();
  const updateCategory = useUpdatePackageCategory();
  ...
  return (
    <>
      ...
      <Container className="p-5 shadow-lg rounded bg-light">
        {/* <h2 className="mb-4 text-center fw-bold">📦 Package Categories</h2> */}
        ...
        {categories.length > 0 ? (
          ...
          <div className="text-center text-muted p-4">
            ...
            <p className="fw-bold">
              No package categories available. Start by creating one!
            </p>
          </div>
        )}
