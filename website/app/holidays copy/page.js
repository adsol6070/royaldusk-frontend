            ...
            <div className="row">
              ...
              <div className="col-lg-9">
                <div className="d-flex justify-content-between align-items-center flex-wrap mb-4">
                  <div>{filteredPackages.length} Packages Found</div>
                  <SortComponent
                    data={packages}
                    ...
                    <div className="content">
                      ...
                      <ul className="blog-meta d-flex flex-wrap">
                        <li className="text-sm">
                          <i className="fas fa-tags" /> {packageItem.category.name}
                        </li>
                        <li className="text-sm">
                          <i className="far fa-hotel" /> Hotels: {packageItem.hotels}
                        </li>
                      </ul>
                      ...
                      <div className="destination-footer d-flex justify-content-between align-items-center">
                        ...
                        <Link href={`/holiday-details/${packageItem.id}`} className="theme-btn style-two style-three">
